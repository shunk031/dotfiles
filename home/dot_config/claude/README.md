...
- Anthropic's `skill-creator` is installed by the run-once skill installer into `~/.claude/skills`; keep it installer-managed unless deliberately promoting it into the shared pool.
