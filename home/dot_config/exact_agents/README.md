...
Installer-managed skills such as `skill-creator` should stay in `~/.claude/skills` unless they are intentionally promoted to the shared pool with that directory-plus-template pair.
